...
export default function LikedScreen({ navigation }) {
  ...
  const contributions = [
    { id: "1", title: "Free Smoothie Samples", image: null },
    { id: "2", title: "In-N-Out Student Discount", image: null },
    { id: "3", title: "20% Off Select Ramen", image: null },
  ];

  const comments = [
    { id: "c1", username: "Username", text: "Loved this event!" },
    { id: "c2", username: "Username", text: "Great post." },
  ];

  useEffect(() => {
    setInitialData([...contributions, ...comments], 13, true);
  }, []);
                        ...
                        <View style={styles.commentActionsRow}>
                          ...
                          >
                            <Ionicons
                              ...
                              size={14}
                              color={
                                likedMap[c.id] ? colors.error : colors.text
                              }
                            />
                            <Text style={styles.commentActionCount}>
                              {engagementCounts[c.id] ?? 0}
                            </Text>
                          </Pressable>
